...
export const properties: Property[] = [
  {
    ...
    description: "6 bedrooms and 5 baths at 71 Morningside Road — on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Listed by Andrea Larsen with BHHS Fox & Roach — private tours available.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "A rare 0.15-acre homesite at 210 Gull Road, Ocean City — bring your architect and draw the beach house from line one. Listed by Andrea Larsen with BHHS Fox & Roach.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "5 bedrooms and 5 baths at 522 Waverly Blvd — on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Listed by Andrea Larsen with BHHS Fox & Roach — private tours available.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "undefined bedrooms and undefined baths at 905-907 Brighton Pl — on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Currently under contract — ask Andrea about comparable homes coming to market.",
    pendingCopy: false,
  ...
  },
  {
    ...
    features: ['Jersey Shore', 'Near the beach', '5 bedrooms'],
    description: "5 bedrooms and 5 baths at 114 Wesley Road — on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Listed by Andrea Larsen with BHHS Fox & Roach — private tours available.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "5 bedrooms and 3 baths at 1 Leyte Ln — 2,382 square feet, on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Currently under contract — ask Andrea about comparable homes coming to market.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "4 bedrooms and 5 baths at 6 Walnut Road — on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Currently under contract — ask Andrea about comparable homes coming to market.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "5 bedrooms and 6 baths at 3213 Bayland Dr — on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Listed by Andrea Larsen with BHHS Fox & Roach — private tours available.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "5 bedrooms and 4 baths at 907 Brighton Pl #2 — lock-and-leave condo living on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Currently under contract — ask Andrea about comparable homes coming to market.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "4 bedrooms and 3 baths at 1100 Central Ave — on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Currently under contract — ask Andrea about comparable homes coming to market.",
    pendingCopy: false,
    ...
    description: "4 bedrooms and 3 baths at 40 Sunset Blvd — 3,780 square feet, minutes from the back bays and Shore Road. Listed by Andrea Larsen with BHHS Fox & Roach — private tours available.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "5 bedrooms and 5 baths at 32 Central Ave — 2,700 square feet, on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Listed by Andrea Larsen with BHHS Fox & Roach — private tours available.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "5 bedrooms and 4 baths at 855 4th Street #2 — 2,500 square feet, lock-and-leave condo living on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Currently under contract — ask Andrea about comparable homes coming to market.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "9 bedrooms and 7 baths at 5606 Pacific Ave — 3,407 square feet, steps from the Crest's wide, free beaches. Listed by Andrea Larsen with BHHS Fox & Roach — private tours available.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "4 bedrooms and 3 baths at 901 Gardens Pkwy — 2,424 square feet, on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Currently under contract — ask Andrea about comparable homes coming to market.",
    pendingCopy: false,
  ...
  },
  {
    ...
    features: ['Jersey Shore', 'Near the beach', '5 bedrooms'],
    description: "5 bedrooms and 4 baths at 302 E 13th Avenue — blocks from the seawall and Hereford Inlet. Listed by Andrea Larsen with BHHS Fox & Roach — private tours available.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "5 bedrooms and 3 baths at 39 Spruce Road — 2,886 square feet, on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Listed by Andrea Larsen with BHHS Fox & Roach — private tours available.",
    pendingCopy: false,
  ...
  },
  {
    ...
    features: ['Jersey Shore', 'Bayside', '5 bedrooms'],
    description: "5 bedrooms and 5 baths at 315 Bay Ave — on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Listed by Andrea Larsen with BHHS Fox & Roach — private tours available.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "5 bedrooms and 4 baths at 857 St Charles Pl #1 — 1,748 square feet, lock-and-leave condo living on America's Greatest Family Resort island, minutes from the beach and the boardwalk. Currently under contract — ask Andrea about comparable homes coming to market.",
    pendingCopy: false,
  ...
  },
  {
    ...
    description: "4 bedrooms and 5 baths at 17 Creek View Ln — 2,764 square feet, on the mainland side of the shore, minutes from the bridges to the beach. Listed by Andrea Larsen with BHHS Fox & Roach — private tours available.",
    pendingCopy: false,
